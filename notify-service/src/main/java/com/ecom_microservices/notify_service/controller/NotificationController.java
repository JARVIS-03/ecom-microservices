...
//  }
@PostMapping("/send")
  public ResponseEntity<NotificationResponseDTO> sendNotification(@Valid @RequestBody OrderDTO orderDTO) {
      NotificationResponseDTO responseDTO = service.createNotification(orderDTO);
      return new ResponseEntity<>(responseDTO, HttpStatus.CREATED);
  }
